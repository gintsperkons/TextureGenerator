...
void TextureGen::VulkanPhysicalDevice::PickPhysicalDevice()
{
...
std::multimap<int, VkPhysicalDevice> TextureGen::VulkanPhysicalDevice::RateDeviceSutability(std::vector<VkPhysicalDevice> devices)
{
...
TextureGen::VulkanPhysicalDevice::VulkanPhysicalDevice(VulkanInstance* instance) 
	:m_InstanceManager(instance), m_physicalDevice(VK_NULL_HANDLE)
{
	PickPhysicalDevice();
}

TextureGen::VulkanPhysicalDevice::~VulkanPhysicalDevice()
{
}
