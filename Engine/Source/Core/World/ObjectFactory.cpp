...
TextureGenEngine::Mesh *TextureGenEngine::ObjectFactory::CreateSquare(float width, float height, float startU, float startV, float endU, float endV)
{
  Vertex3D vertices[] = {
      Vertex3D{glm::vec3(width, 0, 0), glm::vec4(0.5f, 0.5f, 0.0f, 0.0f), glm::vec2(endU, endV)},         // top right
      Vertex3D{glm::vec3(width, height, 0), glm::vec4(0.5f, -0.5f, 0.0f, 0.0f), glm::vec2(endU, startV)}, // bottom right
      Vertex3D{glm::vec3(0, height, 0), glm::vec4(-0.5f, -0.5f, 1.0f, 0.0f), glm::vec2(startU, startV)},  // bottom left
      Vertex3D{glm::vec3(0, 0, 0), glm::vec4(-0.5f, 0.5f, 0.0f, 0.0f), glm::vec2(startU, endV)}           // top left
  };
